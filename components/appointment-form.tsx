...
export default function AppointmentForm({ formValues, setFormValues, saveEvent, setToastOpen }) {
  ...
  return (
    <div className="w-full h-full flex justify-center p-2">
     <form className="flex flex-col gap-[15px] mb-2 font-semibold" onSubmit={saveEvent} >
      <label className="text-lg font-semibold"> Clinic Details:
      ...
      <input type="text" name="title" value={formValues.title} className={inputClass} onChange={onChangeValues} />
      </label>
      ...
      />
      <label className="flex"> Owner Name:
      <input type="text" name="owner" className={inputClass} value={formValues.owner} onChange={onChangeValues} />
      </label>
      <div className="flex flex-col gap-[15px] mb-1">
        <div>Pet Information</div>
        
        <label className="flex">Pet Name:
          <input type="text" name="petName" className={inputClass} value={formValues.petName} onChange={onChangeValues} />
        </label>
        <label className="flex">Breed:
          <input type="text" name="breed" className={inputClass} value={formValues.breed} onChange={onChangeValues} />
        </label>
        <label className="flex"> Age:
          <input type="text" name="petAge" className={inputClass} value={formValues.petAge} onChange={onChangeValues} />
        </label>
        <label className="flex"> Gender:
          <input type="text" name="petGender" className={inputClass} value={formValues.petGender} onChange={onChangeValues} />
        </label>
      </div>
      <label className="flex"> Consultation:
      <input type="text" name="consultation" className={inputClass} value={formValues.consultation} onChange={onChangeValues} />
      </label>
