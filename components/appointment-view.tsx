    ...
    <div className="w-full h-full flex flex-col p-2 items-center">
      ...
      <div className="w-full py-2 border-b-2 border-gray-200 flex flex-col gap-[5px]">
        ...
        <div className="flex">
          ...
          <div className="text-[16px] text-primary ml-[10px]">chrissielee@gmail.com</div>
        </div>
        <div className="flex">
          <div className="text-[16px] text-gray-500 w-[50px]">Phone</div>
          <div className="text-[16px] text-primary ml-[10px]">+01 234 567 8910</div>
        </div>
        <div className="flex">
          <div className="text-[16px] text-gray-500 w-[50px]">Address</div>
          <div className="text-[16px] text-primary ml-[10px]">1st Avenue, Golden Street, Springville Village, San Diego, California</div>
        </div>
      </div>
      ...
      <div className="w-full text-[14px] py-2 border-b-2 border-gray-200 flex flex-col gap-[5px]">
        ...
        <div className="flex">
          <div className="text-[16px] text-gray-500 w-[50px]">Email</div>
          <div className="text-[16px] text-primary ml-[10px]">branch1@gmail.com</div>
        </div>
        <div className="flex">
          <div className="text-[16px] text-gray-500 w-[50px]">Phone</div>
          <div className="text-[16px] text-primary ml-[10px]">{clinic.contact_number}</div>
        </div>
        <div className="flex">
          <div className="text-[16px] text-gray-500 w-[50px]">Address</div>
          <div className="text-[16px] text-primary ml-[10px]">{clinic.building}, {clinic.address} </div>
        </div>
      </div>
      ...
      <div className="w-full py-2 border-b-2 border-gray-200 flex flex-col gap-[5px]">
        ...
        <div className="w-full h-[80px] flex items-center">
          ...
          <div className="w-[150px] pl-[15px]">
            <div className="text-[20px]">{event.petName || 'Anonymous Pet'}</div>
            <div className="text-[16px] text-gray-500">{event.breed || 'NA'}</div>
          </div>
        </div>
        <div className="flex">
          <div className="text-[16px] text-gray-500 w-[50px]">Breed</div>
          <div className="text-[16px] text-primary ml-[10px]">{event.breed || 'NA'}</div>
        </div>
        <div className="flex">
          <div className="text-[16px] text-gray-500 w-[50px]">Sex</div>
          <div className="text-[16px] text-primary ml-[10px]">{event.petGender || 'NA'}</div>
        </div>
        <div className="flex">
          <div className="text-[16px] text-gray-500 w-[50px]">Age</div>
          <div className="text-[16px] text-primary ml-[10px]">{event.petAge || 'NA'}</div>
        </div>
        <div className="flex">
          <div className="text-[16px] text-gray-500 w-[50px]">Birthday</div>
          <div className="text-[16px] text-primary ml-[10px]">{event.petBirth || 'NA'}</div>
        </div>
      </div>
